 ...
 */
export declare enum DarkModeAppearance {
    dark = "dark",
    light = "light",
    system = "system"
}
 ...
 */
export type DarkModeGetter = () => DarkModeGetterResult | Promise<DarkModeGetterResult>;
/**
 * The type of your appearance setter function.
 */
export type DarkModeSetter = (appearance: DarkModeAppearance) => void | Promise<void>;
/**
 * The type of your status bar style getter function.
 */
export type StatusBarStyleGetter = (style?: Style, backgroundColor?: string) => StatusBarStyleGetterResult | Promise<StatusBarStyleGetterResult>;
/**
